...
const GLOSSARY_TERMS = [
    ...
    },
    {
        ...
        category: '長寿',
        explanation: 'Biological Age。戸籍上の「実年齢」とは別に、体の老化の進み具合を年齢になぞらえて表そうとする考え方です。血液や遺伝子のバイオマーカーを測って推定する研究が進められている段階で、測り方によって結果が変わることも知られています。このアプリの「ロンジェビティ・スコア」は記録したチェック項目を集計したもので、こうした測定とは別のもの（年齢には換算していません）。',
